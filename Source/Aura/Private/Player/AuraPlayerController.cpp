...
void AAuraPlayerController::AbilityInputTagReleased(FGameplayTag InputTag)
{
	...
	if (!bTargeting && !bShiftKeyDown)
	{
		...
		if (TimeFollowingCursor <= ShortPressThreshold && ControlledPawn)
		{
			...
			if (GetASC() && !GetASC()->HasMatchingGameplayTag(FAuraGameplayTags::Get().Player_Block_NiagaraCursorSystem))
			{
